  ...
  implements java.security.interfaces.ECPrivateKey, org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder
{
  ...
  public JCEECPrivateKey(String paramString, ECPrivateKeyParameters paramECPrivateKeyParameters, JCEECPublicKey paramJCEECPublicKey, org.bouncycastle.jce.spec.ECParameterSpec paramECParameterSpec)
  {
    ECDomainParameters localECDomainParameters = paramECPrivateKeyParameters.getParameters();
    this.algorithm = paramString;
    this.d = paramECPrivateKeyParameters.getD();
  ...
  public JCEECPrivateKey(String paramString, org.bouncycastle.jce.spec.ECPrivateKeySpec paramECPrivateKeySpec)
  {
    this.algorithm = paramString;
  ...
  private DERBitString getPublicKeyDetails(JCEECPublicKey paramJCEECPublicKey)
  {
    try
    {
      paramJCEECPublicKey = SubjectPublicKeyInfo.getInstance(ASN1Primitive.fromByteArray(paramJCEECPublicKey.getEncoded())).getPublicKeyData();
  ...
  public byte[] getEncoded()
  {
    ...
    if (this.publicKey != null) {
      localObject2 = new ECPrivateKeyStructure(getS(), this.publicKey, (ASN1Encodable)localObject1);
    } else {
    ...
    try
    {
      if (this.algorithm.equals("ECGOST3410")) {
        localObject1 = new PrivateKeyInfo(new AlgorithmIdentifier(CryptoProObjectIdentifiers.gostR3410_2001, ((X962Parameters)localObject1).toASN1Primitive()), ((ECPrivateKeyStructure)localObject2).toASN1Primitive());
      } else {
        localObject1 = new PrivateKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_ecPublicKey, ((X962Parameters)localObject1).toASN1Primitive()), ((ECPrivateKeyStructure)localObject2).toASN1Primitive());
      }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x8af8f000-dex2jar.jar!\org\bouncycastle\jce\provider\JCEECPrivateKey.class
