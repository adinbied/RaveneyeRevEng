...
class CMSSignedHelper
{
  ...
  Store getAttributeCertificates(ASN1Set paramASN1Set)
  {
    ...
    {
      ArrayList localArrayList = new ArrayList(paramASN1Set.size());
      paramASN1Set = paramASN1Set.getObjects();
      while (paramASN1Set.hasMoreElements())
      {
        ASN1Primitive localASN1Primitive = ((ASN1Encodable)paramASN1Set.nextElement()).toASN1Primitive();
  ...
  Store getOtherRevocationInfo(ASN1ObjectIdentifier paramASN1ObjectIdentifier, ASN1Set paramASN1Set)
  {
    if (paramASN1Set != null)
    {
      ...
      while (paramASN1Set.hasMoreElements())
      {
        Object localObject = ((ASN1Encodable)paramASN1Set.nextElement()).toASN1Primitive();
        if ((localObject instanceof ASN1TaggedObject))
        {
          ...
          {
            localObject = OtherRevocationInfoFormat.getInstance((ASN1TaggedObject)localObject, false);
            if (paramASN1ObjectIdentifier.equals(((OtherRevocationInfoFormat)localObject).getInfoFormat())) {
              localArrayList.add(((OtherRevocationInfoFormat)localObject).getInfo());
            }
          }
        }
      }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x8af8f000-dex2jar.jar!\org\bouncycastle\cms\CMSSignedHelper.class
