  ...
  implements CMSSignatureAlgorithmNameGenerator
{
  ...
  {
    Object localObject = getDigestAlgName(paramAlgorithmIdentifier2.getAlgorithm());
    if (!((String)localObject).equals(paramAlgorithmIdentifier2.getAlgorithm().getId()))
    {
      paramAlgorithmIdentifier1 = new StringBuilder();
      paramAlgorithmIdentifier1.append((String)localObject);
      paramAlgorithmIdentifier1.append("with");
      paramAlgorithmIdentifier1.append(getEncryptionAlgName(paramAlgorithmIdentifier2.getAlgorithm()));
      return paramAlgorithmIdentifier1.toString();
    }
    localObject = new StringBuilder();
    ((StringBuilder)localObject).append(getDigestAlgName(paramAlgorithmIdentifier1.getAlgorithm()));
    ((StringBuilder)localObject).append("with");
    ((StringBuilder)localObject).append(getEncryptionAlgName(paramAlgorithmIdentifier2.getAlgorithm()));
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x8af8f000-dex2jar.jar!\org\bouncycastle\cms\DefaultCMSSignatureAlgorithmNameGenerator.class
