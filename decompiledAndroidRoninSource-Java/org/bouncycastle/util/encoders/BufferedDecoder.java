...
public class BufferedDecoder
{
  ...
  public int processByte(byte paramByte, byte[] paramArrayOfByte, int paramInt)
  {
    ...
    if (j == k)
    {
      i = this.translator.decode(arrayOfByte, 0, arrayOfByte.length, paramArrayOfByte, paramInt);
      this.bufOff = 0;
    }
    return i;
  }
  ...
  public int processBytes(byte[] paramArrayOfByte1, int paramInt1, int paramInt2, byte[] paramArrayOfByte2, int paramInt3)
  {
    if (paramInt2 >= 0)
    {
      ...
      if (paramInt2 > m)
      {
        ...
        byte[] arrayOfByte = this.buf;
        i = ((Translator)localObject).decode(arrayOfByte, 0, arrayOfByte.length, paramArrayOfByte2, paramInt3) + 0;
        this.bufOff = 0;
        paramInt2 -= m;
        paramInt1 += m;
        j = paramInt2 - paramInt2 % this.buf.length;
        k = i + this.translator.decode(paramArrayOfByte1, paramInt1, j, paramArrayOfByte2, paramInt3 + i);
        i = paramInt2 - j;
        j = paramInt1 + j;
      }
      if (i != 0)
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x8af8f000-dex2jar.jar!\org\bouncycastl\\util\encoders\BufferedDecoder.class
