...
public class GF2Field
{
  ...
  public static short multElem(short paramShort1, short paramShort2)
  {
    ...
    {
      short[] arrayOfShort1 = exps;
      short[] arrayOfShort2 = logs;
      return arrayOfShort1[((arrayOfShort2[paramShort1] + arrayOfShort2[paramShort2]) % 255)];
    }
    return 0;
  }
}
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x8af8f000-dex2jar.jar!\org\bouncycastle\pqc\crypto\rainbo\\util\GF2Field.class
