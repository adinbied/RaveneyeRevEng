...
class NTT
{
  ...
  static void core(short[] paramArrayOfShort1, short[] paramArrayOfShort2)
  {
    ...
    while (j < 10)
    {
      ...
      while (i < n)
      {
        ...
        while (m < 1023)
        {
          i1 = paramArrayOfShort1[m] & 0xFFFF;
          i2 = m + n;
          i3 = paramArrayOfShort1[i2] & 0xFFFF;
          i4 = paramArrayOfShort2[k];
          paramArrayOfShort1[m] = ((short)(i1 + i3));
          paramArrayOfShort1[i2] = Reduce.montgomery(i4 * (i1 + 36867 - i3));
          m += n * 2;
          k += 1;
        }
        i += 1;
      ...
      while (i < n)
      {
        ...
        while (m < 1023)
        {
          ...
          i3 = paramArrayOfShort1[i2] & 0xFFFF;
          i4 = paramArrayOfShort2[k];
          paramArrayOfShort1[m] = Reduce.barrett((short)(i1 + i3));
          paramArrayOfShort1[i2] = Reduce.montgomery(i4 * (i1 + 36867 - i3));
          m += n * 2;
          k += 1;
        }
  ...
  static void mulCoefficients(short[] paramArrayOfShort1, short[] paramArrayOfShort2)
  {
    ...
    while (i < 1024)
    {
      paramArrayOfShort1[i] = Reduce.montgomery((paramArrayOfShort1[i] & 0xFFFF) * (0xFFFF & paramArrayOfShort2[i]));
      i += 1;
    }
  }
}
