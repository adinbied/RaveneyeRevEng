  ...
  implements PublicKey
{
  ...
  {
    boolean bool3 = paramObject instanceof BCMcEliecePublicKey;
    boolean bool2 = false;
    boolean bool1 = bool2;
    if (bool3)
    {
      ...
      bool1 = bool2;
      if (this.params.getN() == ((BCMcEliecePublicKey)paramObject).getN())
      {
        bool1 = bool2;
        if (this.params.getT() == ((BCMcEliecePublicKey)paramObject).getT())
        {
          bool1 = bool2;
          if (this.params.getG().equals(((BCMcEliecePublicKey)paramObject).getG())) {
            bool1 = true;
          }
        }
      }
  ...
  {
    Object localObject = new McEliecePublicKey(this.params.getN(), this.params.getT(), this.params.getG());
    AlgorithmIdentifier localAlgorithmIdentifier = new AlgorithmIdentifier(PQCObjectIdentifiers.mcEliece);
    try
    {
  ...
  public String toString()
  {
    ...
    localStringBuilder.append(this.params.getG());
    return localStringBuilder.toString();
  }
}


/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x8af8f000-dex2jar.jar!\org\bouncycastle\pqc\jcajce\provider\mceliece\BCMcEliecePublicKey.class
