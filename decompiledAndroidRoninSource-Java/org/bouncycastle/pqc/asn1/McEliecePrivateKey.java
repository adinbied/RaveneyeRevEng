  ...
  extends ASN1Object
{
  ...
  {
    if ((paramObject instanceof McEliecePrivateKey)) {
      return (McEliecePrivateKey)paramObject;
    }
    if (paramObject != null) {
      return new McEliecePrivateKey(ASN1Sequence.getInstance(paramObject));
    }
    return null;
  }
  ...
  public ASN1Primitive toASN1Primitive()
  {
    ...
    localASN1EncodableVector.add(new DEROctetString(this.encP1));
    localASN1EncodableVector.add(new DEROctetString(this.encP2));
    localASN1EncodableVector.add(new DEROctetString(this.encSInv));
    return new DERSequence(localASN1EncodableVector);
  }
}


/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x8af8f000-dex2jar.jar!\org\bouncycastle\pqc\asn1\McEliecePrivateKey.class
