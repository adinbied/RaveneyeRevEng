  ...
  extends SerpentEngineBase
{
  ...
  {
    this.X3 = (this.wKey[''] ^ Pack.bigEndianToInt(paramArrayOfByte1, paramInt1));
    this.X2 = (this.wKey[''] ^ Pack.bigEndianToInt(paramArrayOfByte1, paramInt1 + 4));
    this.X1 = (this.wKey[''] ^ Pack.bigEndianToInt(paramArrayOfByte1, paramInt1 + 8));
    int i = this.wKey[''];
    this.X0 = (Pack.bigEndianToInt(paramArrayOfByte1, paramInt1 + 12) ^ i);
  ...
  protected void encryptBlock(byte[] paramArrayOfByte1, int paramInt1, byte[] paramArrayOfByte2, int paramInt2)
  {
    ...
    Pack.intToBigEndian(this.wKey[''] ^ this.X3, paramArrayOfByte2, paramInt2);
    Pack.intToBigEndian(this.wKey[''] ^ this.X2, paramArrayOfByte2, paramInt2 + 4);
    Pack.intToBigEndian(this.wKey[''] ^ this.X1, paramArrayOfByte2, paramInt2 + 8);
    Pack.intToBigEndian(this.wKey[''] ^ this.X0, paramArrayOfByte2, paramInt2 + 12);
  }
    ...
    throws IllegalArgumentException
  {
    ...
    while (j > 0)
    {
      arrayOfInt[i] = Pack.bigEndianToInt(paramArrayOfByte, j);
      j -= 4;
      i += 1;
    }
    if (j == 0)
    {
      j = i + 1;
      arrayOfInt[i] = Pack.bigEndianToInt(paramArrayOfByte, 0);
      if (j < 8) {
        arrayOfInt[j] = 1;
      }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x8af8f000-dex2jar.jar!\org\bouncycastle\crypto\engines\TnepresEngine.class
