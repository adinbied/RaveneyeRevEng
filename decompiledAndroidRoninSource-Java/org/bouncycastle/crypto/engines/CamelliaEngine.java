  ...
  implements BlockCipher
{
  ...
  private void camelliaF2(int[] paramArrayOfInt1, int[] paramArrayOfInt2, int paramInt)
  {
    ...
    int[] arrayOfInt1 = SBOX4_4404;
    int j = arrayOfInt1[(i & 0xFF)];
    int[] arrayOfInt2 = SBOX3_3033;
    int k = arrayOfInt2[(i >>> 8 & 0xFF)];
    int[] arrayOfInt3 = SBOX2_0222;
    int m = arrayOfInt3[(i >>> 16 & 0xFF)];
    int[] arrayOfInt4 = SBOX1_1110;
    i = arrayOfInt4[(i >>> 24 & 0xFF)] ^ j ^ k ^ m;
    int n = paramArrayOfInt1[1] ^ paramArrayOfInt2[(paramInt + 1)];
    j = arrayOfInt4[(n & 0xFF)];
    k = arrayOfInt1[(n >>> 8 & 0xFF)];
    m = arrayOfInt2[(n >>> 16 & 0xFF)];
    int i1 = arrayOfInt3[(n >>> 24 & 0xFF)];
    n = paramArrayOfInt1[2];
    j = k ^ j ^ m ^ i1 ^ i;
    paramArrayOfInt1[2] = (n ^ j);
    k = paramArrayOfInt1[3];
    paramArrayOfInt1[3] = (rightRotate(i, 8) ^ j ^ k);
    i = paramArrayOfInt1[2] ^ paramArrayOfInt2[(paramInt + 2)];
    arrayOfInt1 = SBOX4_4404;
    j = arrayOfInt1[(i & 0xFF)];
    arrayOfInt2 = SBOX3_3033;
    k = arrayOfInt2[(i >>> 8 & 0xFF)];
    arrayOfInt3 = SBOX2_0222;
    m = arrayOfInt3[(i >>> 16 & 0xFF)];
    arrayOfInt4 = SBOX1_1110;
    i = arrayOfInt4[(i >>> 24 & 0xFF)] ^ j ^ k ^ m;
    j = paramArrayOfInt1[3];
    m = paramArrayOfInt2[(paramInt + 3)] ^ j;
    paramInt = arrayOfInt4[(m & 0xFF)];
    j = arrayOfInt1[(m >>> 8 & 0xFF)];
    k = arrayOfInt2[(m >>> 16 & 0xFF)];
    n = arrayOfInt3[(m >>> 24 & 0xFF)];
    m = paramArrayOfInt1[0];
    paramInt = n ^ paramInt ^ j ^ k ^ i;
    paramArrayOfInt1[0] = (m ^ paramInt);
    j = paramArrayOfInt1[1];
    paramArrayOfInt1[1] = (paramInt ^ rightRotate(i, 8) ^ j);
  }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x8af8f000-dex2jar.jar!\org\bouncycastle\crypto\engines\CamelliaEngine.class
