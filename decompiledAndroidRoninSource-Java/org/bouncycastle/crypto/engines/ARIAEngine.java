  ...
  implements BlockCipher
{
  ...
  protected static void A(byte[] paramArrayOfByte)
  {
    ...
    int i10 = paramArrayOfByte[1];
    int i11 = paramArrayOfByte[2];
    int i8 = paramArrayOfByte[3];
    int i = paramArrayOfByte[4];
    int j = paramArrayOfByte[5];
    int k = paramArrayOfByte[6];
    int m = paramArrayOfByte[7];
    int n = paramArrayOfByte[8];
    int i1 = paramArrayOfByte[9];
    int i2 = paramArrayOfByte[10];
    int i3 = paramArrayOfByte[11];
    int i9 = paramArrayOfByte[12];
    int i4 = paramArrayOfByte[13];
    int i5 = paramArrayOfByte[14];
    int i6 = paramArrayOfByte[15];
    paramArrayOfByte[0] = ((byte)(i8 ^ i ^ k ^ n ^ i1 ^ i4 ^ i5));
    paramArrayOfByte[1] = ((byte)(i11 ^ j ^ m ^ n ^ i1 ^ i9 ^ i6));
    paramArrayOfByte[2] = ((byte)(i10 ^ i ^ k ^ i2 ^ i3 ^ i9 ^ i6));
    paramArrayOfByte[3] = ((byte)(i7 ^ j ^ m ^ i2 ^ i3 ^ i4 ^ i5));
    int i12 = i7 ^ i11;
    paramArrayOfByte[4] = ((byte)(i12 ^ j ^ n ^ i3 ^ i5 ^ i6));
    int i13 = i10 ^ i8;
    paramArrayOfByte[5] = ((byte)(i13 ^ i ^ i1 ^ i2 ^ i5 ^ i6));
    paramArrayOfByte[6] = ((byte)(i12 ^ m ^ i1 ^ i2 ^ i9 ^ i4));
    paramArrayOfByte[7] = ((byte)(i13 ^ k ^ n ^ i3 ^ i9 ^ i4));
    i12 = i7 ^ i10;
    paramArrayOfByte[8] = ((byte)(i12 ^ i ^ m ^ i2 ^ i4 ^ i6));
    paramArrayOfByte[9] = ((byte)(i12 ^ j ^ k ^ i3 ^ i9 ^ i5));
    i12 = i11 ^ i8;
    paramArrayOfByte[10] = ((byte)(i12 ^ j ^ k ^ n ^ i4 ^ i6));
    paramArrayOfByte[11] = ((byte)(i12 ^ i ^ m ^ i1 ^ i9 ^ i5));
    i10 ^= i11;
    paramArrayOfByte[12] = ((byte)(i10 ^ k ^ m ^ i1 ^ i3 ^ i9));
    i7 ^= i8;
    paramArrayOfByte[13] = ((byte)(i7 ^ k ^ m ^ n ^ i2 ^ i4));
    paramArrayOfByte[14] = ((byte)(i7 ^ i ^ j ^ i1 ^ i3 ^ i5));
    paramArrayOfByte[15] = ((byte)(i10 ^ i ^ j ^ n ^ i2 ^ i6));
  }
  ...
  protected static byte[][] keySchedule(boolean paramBoolean, byte[] paramArrayOfByte)
  {
    ...
    if ((i >= 16) && (i <= 32) && ((i & 0x7) == 0))
    {
      ...
      Object localObject1 = localObject2[j];
      byte[] arrayOfByte1 = localObject2[((j + 1) % 3)];
      localObject2 = localObject2[((j + 2) % 3)];
      byte[] arrayOfByte2 = new byte[16];
      byte[] arrayOfByte3 = new byte[16];
      System.arraycopy(paramArrayOfByte, 0, arrayOfByte2, 0, 16);
      System.arraycopy(paramArrayOfByte, 16, arrayOfByte3, 0, i - 16);
      paramArrayOfByte = new byte[16];
      byte[] arrayOfByte4 = new byte[16];
      byte[] arrayOfByte5 = new byte[16];
      byte[] arrayOfByte6 = new byte[16];
      System.arraycopy(arrayOfByte2, 0, paramArrayOfByte, 0, 16);
      System.arraycopy(paramArrayOfByte, 0, arrayOfByte4, 0, 16);
      FO(arrayOfByte4, (byte[])localObject1);
      xor(arrayOfByte4, arrayOfByte3);
      System.arraycopy(arrayOfByte4, 0, arrayOfByte5, 0, 16);
      FE(arrayOfByte5, arrayOfByte1);
      xor(arrayOfByte5, paramArrayOfByte);
      System.arraycopy(arrayOfByte5, 0, arrayOfByte6, 0, 16);
      FO(arrayOfByte6, (byte[])localObject2);
      xor(arrayOfByte6, arrayOfByte4);
      j = j * 2 + 12;
      i = 1;
      localObject1 = (byte[][])Array.newInstance(Byte.TYPE, new int[] { j + 1, 16 });
      keyScheduleRound(localObject1[0], paramArrayOfByte, arrayOfByte4, 19);
      keyScheduleRound(localObject1[1], arrayOfByte4, arrayOfByte5, 19);
      keyScheduleRound(localObject1[2], arrayOfByte5, arrayOfByte6, 19);
      keyScheduleRound(localObject1[3], arrayOfByte6, paramArrayOfByte, 19);
      keyScheduleRound(localObject1[4], paramArrayOfByte, arrayOfByte4, 31);
      keyScheduleRound(localObject1[5], arrayOfByte4, arrayOfByte5, 31);
      keyScheduleRound(localObject1[6], arrayOfByte5, arrayOfByte6, 31);
      keyScheduleRound(localObject1[7], arrayOfByte6, paramArrayOfByte, 31);
      keyScheduleRound(localObject1[8], paramArrayOfByte, arrayOfByte4, 67);
      keyScheduleRound(localObject1[9], arrayOfByte4, arrayOfByte5, 67);
      keyScheduleRound(localObject1[10], arrayOfByte5, arrayOfByte6, 67);
      keyScheduleRound(localObject1[11], arrayOfByte6, paramArrayOfByte, 67);
      keyScheduleRound(localObject1[12], paramArrayOfByte, arrayOfByte4, 97);
      if (j > 12)
      {
        keyScheduleRound(localObject1[13], arrayOfByte4, arrayOfByte5, 97);
        keyScheduleRound(localObject1[14], arrayOfByte5, arrayOfByte6, 97);
        if (j > 14)
        {
          keyScheduleRound(localObject1[15], arrayOfByte6, paramArrayOfByte, 97);
          keyScheduleRound(localObject1[16], paramArrayOfByte, arrayOfByte4, 109);
        }
      }
      if (!paramBoolean)
      {
        reverseKeys((byte[][])localObject1);
        while (i < j)
        {
          A(localObject1[i]);
          i += 1;
  ...
  protected static void keyScheduleRound(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, int paramInt)
  {
    int k = paramInt >>> 3;
    int m = paramInt & 0x7;
    paramInt = paramArrayOfByte3[(15 - k)] & 0xFF;
    int i = 0;
    while (i < 16)
    {
      int j = paramArrayOfByte3[(i - k & 0xF)] & 0xFF;
      paramArrayOfByte1[i] = ((byte)((paramInt << 8 - m | j >>> m) ^ paramArrayOfByte2[i] & 0xFF));
      i += 1;
      paramInt = j;
    }
  }
  ...
  protected static void reverseKeys(byte[][] paramArrayOfByte)
  {
    ...
    while (i < k)
    {
      ...
      int m = j - 1 - i;
      paramArrayOfByte[i] = paramArrayOfByte[m];
      paramArrayOfByte[m] = arrayOfByte;
      i += 1;
    }
  }
    ...
    throws IllegalArgumentException
  {
    ...
    localStringBuilder.append("invalid parameter passed to ARIA init - ");
    ...
    if (this.roundKeys != null)
    {
      if (paramInt1 <= paramArrayOfByte1.length - 16)
      {
        if (paramInt2 <= paramArrayOfByte2.length - 16)
        {
          ...
          int i = this.roundKeys.length;
          int j;
          for (paramInt1 = 0; paramInt1 < i - 3; paramInt1 = j + 1)
          {
            paramArrayOfByte1 = this.roundKeys;
            j = paramInt1 + 1;
            FO(arrayOfByte, paramArrayOfByte1[paramInt1]);
            FE(arrayOfByte, this.roundKeys[j]);
          }
          paramArrayOfByte1 = this.roundKeys;
          i = paramInt1 + 1;
          FO(arrayOfByte, paramArrayOfByte1[paramInt1]);
          xor(arrayOfByte, this.roundKeys[i]);
          SL2(arrayOfByte);
          xor(arrayOfByte, this.roundKeys[(i + 1)]);
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x8af8f000-dex2jar.jar!\org\bouncycastle\crypto\engines\ARIAEngine.class
