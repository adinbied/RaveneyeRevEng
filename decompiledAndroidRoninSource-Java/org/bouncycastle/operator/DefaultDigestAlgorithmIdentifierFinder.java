  ...
  implements DigestAlgorithmIdentifierFinder
{
  ...
  {
    return new AlgorithmIdentifier((ASN1ObjectIdentifier)digestNameToOids.get(paramString), DERNull.INSTANCE);
  }
  ...
  public AlgorithmIdentifier find(AlgorithmIdentifier paramAlgorithmIdentifier)
  {
    if (paramAlgorithmIdentifier.getAlgorithm().equals(PKCSObjectIdentifiers.id_RSASSA_PSS)) {
      return RSASSAPSSparams.getInstance(paramAlgorithmIdentifier.getParameters()).getHashAlgorithm();
    }
    return new AlgorithmIdentifier((ASN1ObjectIdentifier)digestOids.get(paramAlgorithmIdentifier.getAlgorithm()), DERNull.INSTANCE);
  }
}


/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x8af8f000-dex2jar.jar!\org\bouncycastle\operator\DefaultDigestAlgorithmIdentifierFinder.class
