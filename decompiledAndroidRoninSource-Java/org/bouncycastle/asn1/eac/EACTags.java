...
public class EACTags
{
  ...
  {
    int i;
    if (paramASN1ApplicationSpecific.isConstructed()) {
      i = 96;
    } else {
      i = 64;
    }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x89a2c000-dex2jar.jar!\org\bouncycastle\asn1\eac\EACTags.class
