...
public abstract interface PKCSObjectIdentifiers
{
  ...
  static
  {
    ASN1ObjectIdentifier localASN1ObjectIdentifier = new ASN1ObjectIdentifier("1.2.840.113549.1.1");
    pkcs_1 = localASN1ObjectIdentifier;
    rsaEncryption = localASN1ObjectIdentifier.branch("1");
    ...
    sha512_224WithRSAEncryption = pkcs_1.branch("15");
    sha512_256WithRSAEncryption = pkcs_1.branch("16");
    localASN1ObjectIdentifier = new ASN1ObjectIdentifier("1.2.840.113549.1.3");
    pkcs_3 = localASN1ObjectIdentifier;
    dhKeyAgreement = localASN1ObjectIdentifier.branch("1");
    localASN1ObjectIdentifier = new ASN1ObjectIdentifier("1.2.840.113549.1.5");
    pkcs_5 = localASN1ObjectIdentifier;
    pbeWithMD2AndDES_CBC = localASN1ObjectIdentifier.branch("1");
    ...
    localASN1ObjectIdentifier = new ASN1ObjectIdentifier("1.2.840.113549.3");
    encryptionAlgorithm = localASN1ObjectIdentifier;
    des_EDE3_CBC = localASN1ObjectIdentifier.branch("7");
    RC2_CBC = encryptionAlgorithm.branch("2");
    rc4 = encryptionAlgorithm.branch("4");
    localASN1ObjectIdentifier = new ASN1ObjectIdentifier("1.2.840.113549.2");
    digestAlgorithm = localASN1ObjectIdentifier;
    md2 = localASN1ObjectIdentifier.branch("2");
    md4 = digestAlgorithm.branch("4");
    md5 = digestAlgorithm.branch("5");
    id_hmacWithSHA1 = digestAlgorithm.branch("7").intern();
    id_hmacWithSHA224 = digestAlgorithm.branch("8").intern();
    id_hmacWithSHA256 = digestAlgorithm.branch("9").intern();
    id_hmacWithSHA384 = digestAlgorithm.branch("10").intern();
    id_hmacWithSHA512 = digestAlgorithm.branch("11").intern();
    ...
    localASN1ObjectIdentifier = new ASN1ObjectIdentifier("1.2.840.113549.1.9");
    pkcs_9 = localASN1ObjectIdentifier;
    pkcs_9_at_emailAddress = localASN1ObjectIdentifier.branch("1").intern();
    ...
    pkcs_9_at_counterSignature = pkcs_9.branch("6").intern();
    pkcs_9_at_challengePassword = pkcs_9.branch("7").intern();
    pkcs_9_at_unstructuredAddress = pkcs_9.branch("8").intern();
    pkcs_9_at_extendedCertificateAttributes = pkcs_9.branch("9").intern();
    pkcs_9_at_signingDescription = pkcs_9.branch("13").intern();
    pkcs_9_at_extensionRequest = pkcs_9.branch("14").intern();
    pkcs_9_at_smimeCapabilities = pkcs_9.branch("15").intern();
    id_smime = pkcs_9.branch("16").intern();
    pkcs_9_at_friendlyName = pkcs_9.branch("20").intern();
    pkcs_9_at_localKeyId = pkcs_9.branch("21").intern();
    x509certType = pkcs_9.branch("22.1");
    localASN1ObjectIdentifier = pkcs_9.branch("22");
    certTypes = localASN1ObjectIdentifier;
    x509Certificate = localASN1ObjectIdentifier.branch("1").intern();
    sdsiCertificate = certTypes.branch("2").intern();
    localASN1ObjectIdentifier = pkcs_9.branch("23");
    crlTypes = localASN1ObjectIdentifier;
    x509Crl = localASN1ObjectIdentifier.branch("1").intern();
    ...
    localASN1ObjectIdentifier = new ASN1ObjectIdentifier("1.2.840.113549.1.9.16.1");
    id_ct = localASN1ObjectIdentifier;
    id_ct_authData = localASN1ObjectIdentifier.branch("2");
    ...
    localASN1ObjectIdentifier = id_smime.branch("3");
    id_alg = localASN1ObjectIdentifier;
    id_alg_PWRI_KEK = localASN1ObjectIdentifier.branch("9");
    id_rsa_KEM = id_alg.branch("14");
    localASN1ObjectIdentifier = new ASN1ObjectIdentifier("1.2.840.113549.1.9.16.6");
    id_cti = localASN1ObjectIdentifier;
    id_cti_ets_proofOfOrigin = localASN1ObjectIdentifier.branch("1");
    ...
    localASN1ObjectIdentifier = new ASN1ObjectIdentifier("1.2.840.113549.1.9.16.2");
    id_aa = localASN1ObjectIdentifier;
    id_aa_receiptRequest = localASN1ObjectIdentifier.branch("1");
    ...
    localASN1ObjectIdentifier = new ASN1ObjectIdentifier("1.2.840.113549.1.12");
    pkcs_12 = localASN1ObjectIdentifier;
    localASN1ObjectIdentifier = localASN1ObjectIdentifier.branch("10.1");
    bagtypes = localASN1ObjectIdentifier;
    keyBag = localASN1ObjectIdentifier.branch("1");
    ...
    localASN1ObjectIdentifier = pkcs_12.branch("1");
    pkcs_12PbeIds = localASN1ObjectIdentifier;
    pbeWithSHAAnd128BitRC4 = localASN1ObjectIdentifier.branch("1");
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x89a2c000-dex2jar.jar!\org\bouncycastle\asn1\pkcs\PKCSObjectIdentifiers.class
