  ...
  extends ASN1Object
{
  ...
  {
    if ((paramObject instanceof CompressedData)) {
      return (CompressedData)paramObject;
    }
    if (paramObject != null) {
      return new CompressedData(ASN1Sequence.getInstance(paramObject));
    }
    return null;
  }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x89a2c000-dex2jar.jar!\org\bouncycastle\asn1\cms\CompressedData.class
