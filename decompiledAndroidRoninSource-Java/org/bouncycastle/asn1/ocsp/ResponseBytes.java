  ...
  extends ASN1Object
{
  ...
  {
    if ((paramObject instanceof ResponseBytes)) {
      return (ResponseBytes)paramObject;
    }
    if (paramObject != null) {
      return new ResponseBytes(ASN1Sequence.getInstance(paramObject));
    }
    return null;
  }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x89a2c000-dex2jar.jar!\org\bouncycastle\asn1\ocsp\ResponseBytes.class
