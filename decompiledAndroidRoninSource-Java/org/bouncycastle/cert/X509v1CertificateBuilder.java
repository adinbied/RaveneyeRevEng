  ...
  public X509v1CertificateBuilder(X500Name paramX500Name1, BigInteger paramBigInteger, Time paramTime1, Time paramTime2, X500Name paramX500Name2, SubjectPublicKeyInfo paramSubjectPublicKeyInfo)
  {
    if (paramX500Name1 != null)
    {
      if (paramSubjectPublicKeyInfo != null)
      {
        ...
        this.tbsGen = localV1TBSCertificateGenerator;
        localV1TBSCertificateGenerator.setSerialNumber(new ASN1Integer(paramBigInteger));
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x87b1d00c-dex2jar.jar!\org\bouncycastle\cert\X509v1CertificateBuilder.class
