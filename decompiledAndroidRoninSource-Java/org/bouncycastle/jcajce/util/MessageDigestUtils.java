...
public class MessageDigestUtils
{
  ...
  static
  {
    ...
    digestOidMap = localHashMap;
    localHashMap.put(PKCSObjectIdentifiers.md2, "MD2");
  ...
  {
    String str = (String)digestOidMap.get(paramASN1ObjectIdentifier);
    if (str != null) {
      return str;
    }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x8af8f000-dex2jar.jar!\org\bouncycastle\jcajc\\util\MessageDigestUtils.class
