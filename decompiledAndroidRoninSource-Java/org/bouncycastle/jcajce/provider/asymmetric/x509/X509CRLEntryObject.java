  ...
  public byte[] getExtensionValue(String paramString)
  {
    ...
    if (paramString != null) {
      ...
      catch (Exception paramString)
      {
        ...
        localStringBuilder.append("Exception encoding: ");
      ...
      if (localEnumeration.hasMoreElements()) {
        for (Object localObject = "   crlEntryExtensions:";; localObject = "*****")
        {
          ...
          for (;;)
          {
            ...
            try
            {
              if (localASN1ObjectIdentifier.equals(Extension.reasonCode))
              {
              ...
              for (;;)
              {
                localStringBuffer.append(str);
                break;
                if (localASN1ObjectIdentifier.equals(Extension.certificateIssuer))
                {
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x8af8f000-dex2jar.jar!\org\bouncycastle\jcajce\provider\asymmetric\x509\X509CRLEntryObject.class
