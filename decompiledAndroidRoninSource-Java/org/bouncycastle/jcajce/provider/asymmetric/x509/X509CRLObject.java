  ...
  extends X509CRL
{
  ...
  protected X509CRLObject(JcaJceHelper paramJcaJceHelper, CertificateList paramCertificateList)
    throws CRLException
  {
    ...
    {
      paramCertificateList = new StringBuilder();
      paramCertificateList.append("CRL contents invalid: ");
      paramCertificateList.append(paramJcaJceHelper);
      throw new CRLException(paramCertificateList.toString());
    }
  }
  ...
  public boolean hasUnsupportedCriticalExtension()
  {
    ...
    localSet.remove(Extension.issuingDistributionPoint.getId());
    localSet.remove(Extension.deltaCRLIndicator.getId());
        ...
        while (localEnumeration.hasMoreElements())
        {
          ...
          if (localCRLEntry.getUserCertificate().getValue().equals(localBigInteger))
          {
            ...
            catch (CertificateEncodingException paramCertificate)
            {
              ...
              ((StringBuilder)localObject1).append("Cannot process certificate: ");
              ((StringBuilder)localObject1).append(paramCertificate.getMessage());
    ...
    throws CRLException, NoSuchAlgorithmException, InvalidKeyException, NoSuchProviderException, SignatureException
  {
    try
    {
      localSignature = this.bcHelper.createSignature(getSigAlgName());
    }
    catch (Exception localException)
    {
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x8af8f000-dex2jar.jar!\org\bouncycastle\jcajce\provider\asymmetric\x509\X509CRLObject.class
