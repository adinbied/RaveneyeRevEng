  ...
  extends KeyPairGenerator
{
  ...
  public KeyPair generateKeyPair()
  {
    if (this.initialised)
    {
      ...
      if ((localObject3 instanceof org.bouncycastle.jce.spec.ECParameterSpec))
      {
        ...
        localObject2 = new BCDSTU4145PublicKey(this.algorithm, (ECPublicKeyParameters)localObject2, (org.bouncycastle.jce.spec.ECParameterSpec)localObject3);
        return new KeyPair((PublicKey)localObject2, new BCDSTU4145PrivateKey(this.algorithm, (ECPrivateKeyParameters)localObject1, (BCDSTU4145PublicKey)localObject2, (org.bouncycastle.jce.spec.ECParameterSpec)localObject3));
      }
      if (localObject3 == null) {
        return new KeyPair(new BCDSTU4145PublicKey(this.algorithm, (ECPublicKeyParameters)localObject2), new BCDSTU4145PrivateKey(this.algorithm, (ECPrivateKeyParameters)localObject1));
      }
      localObject3 = (java.security.spec.ECParameterSpec)localObject3;
      localObject2 = new BCDSTU4145PublicKey(this.algorithm, (ECPublicKeyParameters)localObject2, (java.security.spec.ECParameterSpec)localObject3);
      return new KeyPair((PublicKey)localObject2, new BCDSTU4145PrivateKey(this.algorithm, (ECPrivateKeyParameters)localObject1, (BCDSTU4145PublicKey)localObject2, (java.security.spec.ECParameterSpec)localObject3));
    }
    ...
    throws InvalidAlgorithmParameterException
  {
    ...
    for (paramAlgorithmParameterSpec = new ECKeyGenerationParameters(new ECDomainParameters(paramAlgorithmParameterSpec, EC5Util.convertPoint(paramAlgorithmParameterSpec, ((java.security.spec.ECParameterSpec)localObject).getGenerator(), false), ((java.security.spec.ECParameterSpec)localObject).getOrder(), BigInteger.valueOf(((java.security.spec.ECParameterSpec)localObject).getCofactor())), paramSecureRandom);; paramAlgorithmParameterSpec = new ECKeyGenerationParameters(new ECDomainParameters((ECCurve)localObject, EC5Util.convertPoint((ECCurve)localObject, paramAlgorithmParameterSpec.getGenerator(), false), paramAlgorithmParameterSpec.getOrder(), BigInteger.valueOf(paramAlgorithmParameterSpec.getCofactor())), paramSecureRandom))
    {
      ...
      localObject = DSTU4145NamedCurves.getByOID(new ASN1ObjectIdentifier(paramAlgorithmParameterSpec));
      if (localObject == null) {
        break label446;
      }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x8af8f000-dex2jar.jar!\org\bouncycastle\jcajce\provider\asymmetric\dstu\KeyPairGeneratorSpi.class
