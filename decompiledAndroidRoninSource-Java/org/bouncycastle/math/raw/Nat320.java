...
public abstract class Nat320
{
  ...
  public static BigInteger toBigInteger64(long[] paramArrayOfLong)
  {
    ...
    while (i < 5)
    {
      ...
      if (l != 0L) {
        Pack.longToBigEndian(l, arrayOfByte, 4 - i << 3);
      }
      i += 1;
    }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x8af8f000-dex2jar.jar!\org\bouncycastle\math\raw\Nat320.class
