...
public abstract class Nat576
{
  ...
  public static BigInteger toBigInteger64(long[] paramArrayOfLong)
  {
    ...
    while (i < 9)
    {
      ...
      if (l != 0L) {
        Pack.longToBigEndian(l, arrayOfByte, 8 - i << 3);
      }
      i += 1;
    }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x8af8f000-dex2jar.jar!\org\bouncycastle\math\raw\Nat576.class
