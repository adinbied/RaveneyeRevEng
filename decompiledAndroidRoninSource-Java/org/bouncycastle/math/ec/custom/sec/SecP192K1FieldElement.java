  ...
  extends ECFieldElement
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    return Nat192.eq(this.x, ((SecP192K1FieldElement)paramObject).x);
  }
  ...
  public ECFieldElement sqrt()
  {
    ...
    if (!Nat192.isZero(arrayOfInt1))
    {
      ...
      SecP192K1Field.squareN(arrayOfInt4, 2, arrayOfInt4);
      SecP192K1Field.multiply(arrayOfInt4, arrayOfInt2, arrayOfInt4);
      SecP192K1Field.squareN(arrayOfInt4, 8, arrayOfInt2);
      SecP192K1Field.multiply(arrayOfInt2, arrayOfInt4, arrayOfInt2);
      SecP192K1Field.squareN(arrayOfInt2, 3, arrayOfInt4);
      SecP192K1Field.multiply(arrayOfInt4, arrayOfInt3, arrayOfInt4);
      int[] arrayOfInt5 = Nat192.create();
      SecP192K1Field.squareN(arrayOfInt4, 16, arrayOfInt5);
      SecP192K1Field.multiply(arrayOfInt5, arrayOfInt2, arrayOfInt5);
      SecP192K1Field.squareN(arrayOfInt5, 35, arrayOfInt2);
      SecP192K1Field.multiply(arrayOfInt2, arrayOfInt5, arrayOfInt2);
      SecP192K1Field.squareN(arrayOfInt2, 70, arrayOfInt5);
      SecP192K1Field.multiply(arrayOfInt5, arrayOfInt2, arrayOfInt5);
      SecP192K1Field.squareN(arrayOfInt5, 19, arrayOfInt2);
      SecP192K1Field.multiply(arrayOfInt2, arrayOfInt4, arrayOfInt2);
      SecP192K1Field.squareN(arrayOfInt2, 20, arrayOfInt2);
      SecP192K1Field.multiply(arrayOfInt2, arrayOfInt4, arrayOfInt2);
      SecP192K1Field.squareN(arrayOfInt2, 4, arrayOfInt2);
      SecP192K1Field.multiply(arrayOfInt2, arrayOfInt3, arrayOfInt2);
      SecP192K1Field.squareN(arrayOfInt2, 6, arrayOfInt2);
      SecP192K1Field.multiply(arrayOfInt2, arrayOfInt3, arrayOfInt2);
      SecP192K1Field.square(arrayOfInt2, arrayOfInt2);
      SecP192K1Field.square(arrayOfInt2, arrayOfInt3);
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x8af8f000-dex2jar.jar!\org\bouncycastle\math\ec\custom\sec\SecP192K1FieldElement.class
