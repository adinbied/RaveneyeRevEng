  ...
  extends ECPoint.AbstractF2m
{
  ...
  public ECPoint add(ECPoint paramECPoint)
  {
    ...
    if (localECFieldElement3.isZero())
    {
      ...
      if (((ECFieldElement)localObject2).isZero()) {
        return new SecT283K1Point(localECCurve, (ECFieldElement)localObject2, localECCurve.getB(), this.withCompression);
      }
    ...
    return new SecT283K1Point(localECCurve, (ECFieldElement)localObject2, (ECFieldElement)localObject3, new ECFieldElement[] { localObject1 }, bool1);
  }
  ...
  public ECPoint negate()
  {
    ...
    return new SecT283K1Point(localECCurve, localECFieldElement1, localECFieldElement3, new ECFieldElement[] { localECFieldElement2 }, bool);
  }
  ...
  public ECPoint twice()
  {
    ...
    if (localECFieldElement1.isZero()) {
      return new SecT283K1Point(localECCurve, localECFieldElement1, localECCurve.getB(), this.withCompression);
    }
    ...
    return new SecT283K1Point(localECCurve, localECFieldElement7, localECFieldElement1, new ECFieldElement[] { localECFieldElement4 }, bool);
  }
  ...
  public ECPoint twicePlus(ECPoint paramECPoint)
  {
    ...
    if ((!localECFieldElement2.isZero()) && (localECFieldElement3.isOne()))
    {
      ...
      if (localECFieldElement5.isZero()) {
        return new SecT283K1Point(localECCurve, localECFieldElement5, localECCurve.getB(), this.withCompression);
      }
      ...
      boolean bool = this.withCompression;
      return new SecT283K1Point(localECCurve, paramECPoint, localECFieldElement2, new ECFieldElement[] { localECFieldElement1 }, bool);
    }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x8af8f000-dex2jar.jar!\org\bouncycastle\math\ec\custom\sec\SecT283K1Point.class
