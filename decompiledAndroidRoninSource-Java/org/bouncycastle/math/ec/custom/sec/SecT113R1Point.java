  ...
  extends ECPoint.AbstractF2m
{
  ...
  public ECPoint add(ECPoint paramECPoint)
  {
    ...
    if (localECFieldElement3.isZero())
    {
      ...
      if (((ECFieldElement)localObject2).isZero()) {
        return new SecT113R1Point(localECCurve, (ECFieldElement)localObject2, localECCurve.getB().sqrt(), this.withCompression);
      }
    ...
    return new SecT113R1Point(localECCurve, (ECFieldElement)localObject2, (ECFieldElement)localObject3, new ECFieldElement[] { localObject1 }, bool1);
  }
  ...
  public ECPoint negate()
  {
    ...
    return new SecT113R1Point(localECCurve, localECFieldElement1, localECFieldElement3, new ECFieldElement[] { localECFieldElement2 }, bool);
  }
  ...
  public ECPoint twice()
  {
    ...
    if (localECFieldElement6.isZero()) {
      return new SecT113R1Point(localECCurve, localECFieldElement6, localECCurve.getB().sqrt(), this.withCompression);
    }
    ...
    return new SecT113R1Point(localECCurve, localECFieldElement7, localECFieldElement1, new ECFieldElement[] { localECFieldElement2 }, bool);
  }
  ...
  public ECPoint twicePlus(ECPoint paramECPoint)
  {
    ...
    if ((!localECFieldElement2.isZero()) && (localECFieldElement3.isOne()))
    {
      ...
      if (localECFieldElement5.isZero()) {
        return new SecT113R1Point(localECCurve, localECFieldElement5, localECCurve.getB().sqrt(), this.withCompression);
      }
      ...
      boolean bool = this.withCompression;
      return new SecT113R1Point(localECCurve, paramECPoint, localECFieldElement2, new ECFieldElement[] { localECFieldElement1 }, bool);
    }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x8af8f000-dex2jar.jar!\org\bouncycastle\math\ec\custom\sec\SecT113R1Point.class
