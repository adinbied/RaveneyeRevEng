  ...
  extends ECPoint.AbstractF2m
{
  ...
  public ECPoint add(ECPoint paramECPoint)
  {
    ...
    if (localECFieldElement3.isZero())
    {
      ...
      if (((ECFieldElement)localObject2).isZero()) {
        return new SecT409R1Point(localECCurve, (ECFieldElement)localObject2, localECCurve.getB().sqrt(), this.withCompression);
      }
    ...
    return new SecT409R1Point(localECCurve, (ECFieldElement)localObject2, (ECFieldElement)localObject3, new ECFieldElement[] { localObject1 }, bool1);
  }
  ...
  public ECPoint negate()
  {
    ...
    return new SecT409R1Point(localECCurve, localECFieldElement1, localECFieldElement3, new ECFieldElement[] { localECFieldElement2 }, bool);
  }
  ...
  public ECPoint twice()
  {
    ...
    ECFieldElement localECFieldElement4 = this.zs[0];
    boolean bool = localECFieldElement4.isOne();
    if (bool) {
      localECFieldElement1 = localECFieldElement5;
    } else {
      localECFieldElement1 = localECFieldElement5.multiply(localECFieldElement4);
    }
    ECFieldElement localECFieldElement2;
    if (bool) {
      localECFieldElement2 = localECFieldElement4;
    } else {
      localECFieldElement2 = localECFieldElement4.square();
    }
    localECFieldElement5 = localECFieldElement5.square().add(localECFieldElement1).add(localECFieldElement2);
    if (localECFieldElement5.isZero()) {
      return new SecT409R1Point(localECCurve, localECFieldElement5, localECCurve.getB().sqrt(), this.withCompression);
    }
    ECFieldElement localECFieldElement6 = localECFieldElement5.square();
    if (bool) {
      localECFieldElement2 = localECFieldElement5;
    } else {
      localECFieldElement2 = localECFieldElement5.multiply(localECFieldElement2);
    }
    if (!bool) {
      localECFieldElement3 = localECFieldElement3.multiply(localECFieldElement4);
    }
    ECFieldElement localECFieldElement1 = localECFieldElement3.squarePlusProduct(localECFieldElement5, localECFieldElement1).add(localECFieldElement6).add(localECFieldElement2);
    bool = this.withCompression;
    return new SecT409R1Point(localECCurve, localECFieldElement6, localECFieldElement1, new ECFieldElement[] { localECFieldElement2 }, bool);
  }
  ...
  public ECPoint twicePlus(ECPoint paramECPoint)
  {
    ...
    if ((!localECFieldElement3.isZero()) && (localECFieldElement1.isOne()))
    {
      ...
      boolean bool = this.withCompression;
      return new SecT409R1Point(localECCurve, paramECPoint, localECFieldElement1, new ECFieldElement[] { localECFieldElement2 }, bool);
    }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x8af8f000-dex2jar.jar!\org\bouncycastle\math\ec\custom\sec\SecT409R1Point.class
