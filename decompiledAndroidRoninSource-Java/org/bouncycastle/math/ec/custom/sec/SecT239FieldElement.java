  ...
  extends ECFieldElement
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    paramObject = (SecT239FieldElement)paramObject;
    return Nat256.eq64(this.x, ((SecT239FieldElement)paramObject).x);
  }
  ...
  public ECFieldElement multiplyPlusProduct(ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2, ECFieldElement paramECFieldElement3)
  {
    ...
    paramECFieldElement1 = ((SecT239FieldElement)paramECFieldElement1).x;
    paramECFieldElement2 = ((SecT239FieldElement)paramECFieldElement2).x;
    long[] arrayOfLong2 = ((SecT239FieldElement)paramECFieldElement3).x;
    paramECFieldElement3 = Nat256.createExt64();
    SecT239Field.multiplyAddToExt(arrayOfLong1, paramECFieldElement1, paramECFieldElement3);
    SecT239Field.multiplyAddToExt(paramECFieldElement2, arrayOfLong2, paramECFieldElement3);
    paramECFieldElement1 = Nat256.create64();
    SecT239Field.reduce(paramECFieldElement3, paramECFieldElement1);
    return new SecT239FieldElement(paramECFieldElement1);
  }
  ...
  public ECFieldElement squarePlusProduct(ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2)
  {
    long[] arrayOfLong1 = this.x;
    paramECFieldElement1 = ((SecT239FieldElement)paramECFieldElement1).x;
    long[] arrayOfLong2 = ((SecT239FieldElement)paramECFieldElement2).x;
    paramECFieldElement2 = Nat256.createExt64();
    SecT239Field.squareAddToExt(arrayOfLong1, paramECFieldElement2);
    SecT239Field.multiplyAddToExt(paramECFieldElement1, arrayOfLong2, paramECFieldElement2);
    paramECFieldElement1 = Nat256.create64();
    SecT239Field.reduce(paramECFieldElement2, paramECFieldElement1);
    return new SecT239FieldElement(paramECFieldElement1);
  }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x8af8f000-dex2jar.jar!\org\bouncycastle\math\ec\custom\sec\SecT239FieldElement.class
