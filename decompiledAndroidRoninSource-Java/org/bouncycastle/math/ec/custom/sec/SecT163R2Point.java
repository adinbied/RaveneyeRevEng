  ...
  extends ECPoint.AbstractF2m
{
  ...
  public ECPoint add(ECPoint paramECPoint)
  {
    ...
    if (localECFieldElement3.isZero())
    {
      ...
      if (((ECFieldElement)localObject2).isZero()) {
        return new SecT163R2Point(localECCurve, (ECFieldElement)localObject2, localECCurve.getB().sqrt(), this.withCompression);
      }
    ...
    return new SecT163R2Point(localECCurve, (ECFieldElement)localObject2, (ECFieldElement)localObject3, new ECFieldElement[] { localObject1 }, bool1);
  }
  ...
  public ECPoint negate()
  {
    ...
    return new SecT163R2Point(localECCurve, localECFieldElement1, localECFieldElement3, new ECFieldElement[] { localECFieldElement2 }, bool);
  }
  ...
  public ECPoint twice()
  {
    ...
    if (localECFieldElement5.isZero()) {
      return new SecT163R2Point(localECCurve, localECFieldElement5, localECCurve.getB().sqrt(), this.withCompression);
    }
    ...
    return new SecT163R2Point(localECCurve, localECFieldElement6, localECFieldElement1, new ECFieldElement[] { localECFieldElement2 }, bool);
  }
  ...
  public ECPoint twicePlus(ECPoint paramECPoint)
  {
    ...
    if ((!localECFieldElement3.isZero()) && (localECFieldElement1.isOne()))
    {
      ...
      boolean bool = this.withCompression;
      return new SecT163R2Point(localECCurve, paramECPoint, localECFieldElement1, new ECFieldElement[] { localECFieldElement2 }, bool);
    }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x8af8f000-dex2jar.jar!\org\bouncycastle\math\ec\custom\sec\SecT163R2Point.class
