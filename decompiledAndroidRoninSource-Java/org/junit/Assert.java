...
public class Assert
{
  ...
  static String format(String paramString, Object paramObject1, Object paramObject2)
  {
    ...
    ((StringBuilder)paramObject1).append("expected:<");
    ((StringBuilder)paramObject1).append(paramString);
    ((StringBuilder)paramObject1).append("> but was:<");
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x8af8f000-dex2jar.jar!\org\junit\Assert.class
