...
public class IcoMetadataReader
{
  ...
  public static Metadata readMetadata(InputStream paramInputStream)
  {
    ...
    new IcoReader().extract(new StreamReader(paramInputStream), localMetadata);
    return localMetadata;
  }
}


/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x89a2c000-dex2jar.jar!\com\drew\imaging\ico\IcoMetadataReader.class
