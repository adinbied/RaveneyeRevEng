...
public class OlympusEquipmentMakernoteDescriptor
  extends TagDescriptor<OlympusEquipmentMakernoteDirectory>
{
  ...
  static
  {
    _olympusExtenderTypes = new HashMap();
  ...
  public OlympusEquipmentMakernoteDescriptor(OlympusEquipmentMakernoteDirectory paramOlympusEquipmentMakernoteDirectory)
  {
    super(paramOlympusEquipmentMakernoteDirectory);
  }
  
  private static double CalcMaxAperture(int paramInt)
  {
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x89a2c000-dex2jar.jar!\com\drew\metadata\exif\makernotes\OlympusEquipmentMakernoteDescriptor.class
