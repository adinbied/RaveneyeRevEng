  ...
  extends Directory
{
  ...
  static
  {
    ...
    _tagNameMap.put(Integer.valueOf(640), "Preview Image");
    ...
    _tagNameMap.put(Integer.valueOf(1028), "Serial Number");
    ...
    _tagNameMap.put(Integer.valueOf(3841), "Data Dump 2");
    ...
    _tagNameMap.put(Integer.valueOf(4103), "Sensor Temperature");
    _tagNameMap.put(Integer.valueOf(4104), "Lens Temperature");
    _tagNameMap.put(Integer.valueOf(4105), "Light Condition");
    ...
    _tagNameMap.put(Integer.valueOf(4116), "Color Temperature RG");
    _tagNameMap.put(Integer.valueOf(4117), "White Balance Mode");
    _tagNameMap.put(Integer.valueOf(4119), "Red Balance");
    _tagNameMap.put(Integer.valueOf(4120), "Blue Balance");
    _tagNameMap.put(Integer.valueOf(4121), "Color Matrix Number");
    _tagNameMap.put(Integer.valueOf(4122), "Serial Number");
    _tagNameMap.put(Integer.valueOf(4123), "External Flash AE1 0");
    _tagNameMap.put(Integer.valueOf(4124), "External Flash AE2 0");
    _tagNameMap.put(Integer.valueOf(4125), "Internal Flash AE1 0");
    _tagNameMap.put(Integer.valueOf(4126), "Internal Flash AE2 0");
    _tagNameMap.put(Integer.valueOf(4127), "External Flash AE1");
    _tagNameMap.put(Integer.valueOf(4128), "External Flash AE2");
    _tagNameMap.put(Integer.valueOf(4129), "Internal Flash AE1");
    _tagNameMap.put(Integer.valueOf(4130), "Internal Flash AE2");
    _tagNameMap.put(Integer.valueOf(4131), "Flash Bias");
    _tagNameMap.put(Integer.valueOf(4132), "Internal Flash Table");
    _tagNameMap.put(Integer.valueOf(4133), "External Flash G Value");
    _tagNameMap.put(Integer.valueOf(4134), "External Flash Bounce");
    _tagNameMap.put(Integer.valueOf(4135), "External Flash Zoom");
    _tagNameMap.put(Integer.valueOf(4136), "External Flash Mode");
    ...
    _tagNameMap.put(Integer.valueOf(4142), "Olympus Image Width");
    _tagNameMap.put(Integer.valueOf(4143), "Olympus Image Height");
    ...
    _tagNameMap.put(Integer.valueOf(4149), "Preview Image Valid");
    _tagNameMap.put(Integer.valueOf(4150), "Preview Image Start");
    _tagNameMap.put(Integer.valueOf(4151), "Preview Image Length");
    _tagNameMap.put(Integer.valueOf(4152), "AF Result");
    _tagNameMap.put(Integer.valueOf(4153), "CCD Scan Mode");
    _tagNameMap.put(Integer.valueOf(4154), "Noise Reduction");
    _tagNameMap.put(Integer.valueOf(4155), "Infinity Lens Step");
    _tagNameMap.put(Integer.valueOf(4156), "Near Lens Step");
    _tagNameMap.put(Integer.valueOf(4157), "Light Value Center");
    _tagNameMap.put(Integer.valueOf(4158), "Light Value Periphery");
    _tagNameMap.put(Integer.valueOf(4159), "Field Count");
    _tagNameMap.put(Integer.valueOf(8208), "Equipment");
    _tagNameMap.put(Integer.valueOf(8224), "Camera Settings");
    _tagNameMap.put(Integer.valueOf(8240), "Raw Development");
    _tagNameMap.put(Integer.valueOf(8241), "Raw Development 2");
    _tagNameMap.put(Integer.valueOf(8256), "Image Processing");
    _tagNameMap.put(Integer.valueOf(8272), "Focus Info");
    _tagNameMap.put(Integer.valueOf(12288), "Raw Info");
    _tagNameMap.put(Integer.valueOf(16384), "Main Info");
    _tagNameMap.put(Integer.valueOf(61442), "Exposure Mode");
    _tagNameMap.put(Integer.valueOf(61443), "Flash Mode");
    _tagNameMap.put(Integer.valueOf(61444), "White Balance");
    _tagNameMap.put(Integer.valueOf(61445), "Image Size");
    _tagNameMap.put(Integer.valueOf(61446), "Image Quality");
    _tagNameMap.put(Integer.valueOf(61447), "Shooting Mode");
    _tagNameMap.put(Integer.valueOf(61448), "Metering Mode");
    _tagNameMap.put(Integer.valueOf(61449), "Apex Film Speed Value");
    _tagNameMap.put(Integer.valueOf(61450), "Apex Shutter Speed Time Value");
    _tagNameMap.put(Integer.valueOf(61451), "Apex Aperture Value");
    _tagNameMap.put(Integer.valueOf(61452), "Macro Mode");
    _tagNameMap.put(Integer.valueOf(61453), "Digital Zoom");
    _tagNameMap.put(Integer.valueOf(61454), "Exposure Compensation");
    _tagNameMap.put(Integer.valueOf(61455), "Bracket Step");
    _tagNameMap.put(Integer.valueOf(61457), "Interval Length");
    _tagNameMap.put(Integer.valueOf(61458), "Interval Number");
    _tagNameMap.put(Integer.valueOf(61459), "Focal Length");
    _tagNameMap.put(Integer.valueOf(61460), "Focus Distance");
    _tagNameMap.put(Integer.valueOf(61461), "Flash Fired");
    _tagNameMap.put(Integer.valueOf(61462), "Date");
    _tagNameMap.put(Integer.valueOf(61463), "Time");
    _tagNameMap.put(Integer.valueOf(61464), "Max Aperture at Focal Length");
    _tagNameMap.put(Integer.valueOf(61467), "File Number Memory");
    _tagNameMap.put(Integer.valueOf(61468), "Last File Number");
    _tagNameMap.put(Integer.valueOf(61469), "White Balance Red");
    _tagNameMap.put(Integer.valueOf(61470), "White Balance Green");
    _tagNameMap.put(Integer.valueOf(61471), "White Balance Blue");
    _tagNameMap.put(Integer.valueOf(61472), "Saturation");
    _tagNameMap.put(Integer.valueOf(61473), "Contrast");
    _tagNameMap.put(Integer.valueOf(61474), "Sharpness");
    _tagNameMap.put(Integer.valueOf(61475), "Subject Program");
    _tagNameMap.put(Integer.valueOf(61476), "Flash Compensation");
    _tagNameMap.put(Integer.valueOf(61477), "ISO Setting");
    _tagNameMap.put(Integer.valueOf(61478), "Camera Model");
    _tagNameMap.put(Integer.valueOf(61479), "Interval Mode");
    _tagNameMap.put(Integer.valueOf(61480), "Folder Name");
    _tagNameMap.put(Integer.valueOf(61481), "Color Mode");
    _tagNameMap.put(Integer.valueOf(61482), "Color Filter");
    _tagNameMap.put(Integer.valueOf(61483), "Black and White Filter");
    _tagNameMap.put(Integer.valueOf(61484), "Internal Flash");
    _tagNameMap.put(Integer.valueOf(61485), "Apex Brightness Value");
    _tagNameMap.put(Integer.valueOf(61486), "Spot Focus Point X Coordinate");
    _tagNameMap.put(Integer.valueOf(61487), "Spot Focus Point Y Coordinate");
    _tagNameMap.put(Integer.valueOf(61488), "Wide Focus Zone");
    _tagNameMap.put(Integer.valueOf(61489), "Focus Mode");
    _tagNameMap.put(Integer.valueOf(61490), "Focus Area");
    _tagNameMap.put(Integer.valueOf(61491), "DEC Switch Position");
    localHashMap = new HashMap();
    OlympusCameraTypes = localHashMap;
    localHashMap.put("D4028", "X-2,C-50Z");
  ...
  /* Error */
  private void processCameraSettings(byte[] arg1)
  {
    // Byte code:
    //   0: return
    //   1: astore_1
  ...
  /* Error */
  public void setByteArray(int arg1, byte[] arg2)
  {
    // Byte code:
    //   0: return
    //   1: astore_2
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x89a2c000-dex2jar.jar!\com\drew\metadata\exif\makernotes\OlympusMakernoteDirectory.class
