  ...
  implements CloneableDrawable
{
  ...
  private void drawHorizontalBar(Canvas paramCanvas, int paramInt1, int paramInt2)
  {
    ...
    int m = this.mPadding;
    int j = this.mBarWidth;
    k = k - m - j;
    this.mRect.set(i, k, i + paramInt1, k + j);
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x89a2c000-dex2jar.jar!\com\facebook\drawee\drawable\ProgressBarDrawable.class
