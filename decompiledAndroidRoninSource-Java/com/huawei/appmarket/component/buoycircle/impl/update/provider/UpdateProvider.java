  ...
  extends ContentProvider
{
  ...
  {
    mUriHelper.setContext(paramContext);
    return mUriHelper.getLocalFile(paramString);
  }
  
  public static Uri getUriForFile(Context paramContext, String paramString, File paramFile)
  {
    mUriHelper.setContext(paramContext);
    return mUriHelper.getUriForFile(paramFile, paramString);
  }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x89a2c000-dex2jar.jar!\com\huawei\appmarket\component\buoycircle\imp\\update\provider\UpdateProvider.class
