...
public class ix
  implements iz<ix, Object>, Serializable, Cloneable
{
  private static final jh jdField_a_of_type_ComXiaomiPushJh;
  private static final jp jdField_a_of_type_ComXiaomiPushJp = new jp("XmPushActionUnSubscriptionResult");
  ...
  private static final jh h = new jh("", (byte)11, (short)9);
  private static final jh i = new jh("", (byte)11, (short)10);
  public long a;
  public id a;
  public String a;
  ...
  static
  {
    ...
    jdField_f_of_type_ComXiaomiPushJh = new jh("", (byte)11, (short)7);
    jdField_g_of_type_ComXiaomiPushJh = new jh("", (byte)11, (short)8);
  }
  
  public int a(ix paramix)
  {
    return 0;
  }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x89a2c000-dex2jar.jar!\com\xiaomi\push\ix.class
