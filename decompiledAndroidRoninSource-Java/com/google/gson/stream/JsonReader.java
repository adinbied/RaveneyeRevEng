  ...
  implements Closeable
{
    ...
    throws IOException
  {
    ...
    for (;;)
    {
      ...
      if ((i == 2) && (bool1) && ((l1 != Long.MIN_VALUE) || (m != 0)) && ((l1 != 0L) || (m == 0)))
      {
        if (m == 0) {
          l1 = -l1;
        }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x89a2c000-dex2jar.jar!\com\google\gson\stream\JsonReader.class
