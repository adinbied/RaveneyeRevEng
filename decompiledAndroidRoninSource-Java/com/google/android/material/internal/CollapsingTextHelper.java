...
public final class CollapsingTextHelper
{
  ...
  private void calculateUsingTextSize(float paramFloat)
  {
    ...
    if ((this.textToDraw == null) || (j != 0))
    {
      ...
      if (!TextUtils.equals((CharSequence)localObject, this.textToDraw))
      {
        ...
        this.isRtl = calculateIsRtl((CharSequence)localObject);
      }
    }
  }
  ...
  private void ensureExpandedTexture()
  {
    if ((this.expandedTitleTexture == null) && (!this.expandedBounds.isEmpty()))
    {
      ...
      if (i > 0)
      {
        ...
        localObject = new Canvas(this.expandedTitleTexture);
        localCharSequence = this.textToDraw;
        ((Canvas)localObject).drawText(localCharSequence, 0, localCharSequence.length(), 0.0F, j - this.textPaint.descent(), this.textPaint);
  ...
  private int getCurrentExpandedTextColor()
  {
    ...
    if (arrayOfInt != null) {
      return this.expandedTextColor.getColorForState(arrayOfInt, 0);
    }
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if ((this.textToDraw != null) && (this.drawTitle))
    {
      ...
      {
        CharSequence localCharSequence = this.textToDraw;
        paramCanvas.drawText(localCharSequence, 0, localCharSequence.length(), f4, f1, this.textPaint);
      }
    }
  ...
  public void getCollapsedTextActualBounds(RectF paramRectF)
  {
    ...
    if (!bool) {
      ...
      f = localRect.right - calculateCollapsedTextWidth();
    }
    paramRectF.left = f;
  ...
  public int getCurrentCollapsedTextColor()
  {
    int[] arrayOfInt = this.state;
    if (arrayOfInt != null) {
      return this.collapsedTextColor.getColorForState(arrayOfInt, 0);
    }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x89a2c000-dex2jar.jar!\com\google\android\material\internal\CollapsingTextHelper.class
