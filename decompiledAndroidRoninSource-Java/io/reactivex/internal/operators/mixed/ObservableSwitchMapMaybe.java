  ...
  extends Observable<R>
{
    ...
    implements Observer<T>, Disposable
  {
    ...
    SwitchMapMaybeMainObserver(Observer<? super R> paramObserver, Function<? super T, ? extends MaybeSource<? extends R>> paramFunction, boolean paramBoolean)
    {
      ...
      implements MaybeObserver<R>
    {
      ...
      SwitchMapMaybeObserver(ObservableSwitchMapMaybe.SwitchMapMaybeMainObserver<?, R> paramSwitchMapMaybeMainObserver)
      {
        this.parent = paramSwitchMapMaybeMainObserver;
      }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x87b1d00c-dex2jar.jar!\io\reactivex\internal\operators\mixed\ObservableSwitchMapMaybe.class
