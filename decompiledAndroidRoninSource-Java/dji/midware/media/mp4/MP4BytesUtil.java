...
public class MP4BytesUtil
{
  ...
  {
    return ByteBuffer.wrap(fillBytes(paramArrayOfByte, 8)).order(ByteOrder.BIG_ENDIAN).getDouble();
  }
  
  public static double getDouble(byte[] paramArrayOfByte, int paramInt)
  {
    return ByteBuffer.wrap(fillBytes(paramArrayOfByte, 8), paramInt, 8).order(ByteOrder.BIG_ENDIAN).getDouble();
  }
  
  public static float getFloat(byte[] paramArrayOfByte)
  {
    return ByteBuffer.wrap(fillBytes(paramArrayOfByte, 4)).order(ByteOrder.BIG_ENDIAN).getFloat();
  }
  
  public static float getFloat(byte[] paramArrayOfByte, int paramInt)
  {
    return ByteBuffer.wrap(fillBytes(paramArrayOfByte, 4), paramInt, 4).order(ByteOrder.BIG_ENDIAN).getFloat();
  }
  ...
  {
    return ByteBuffer.wrap(fillBytes(paramArrayOfByte, 4)).order(ByteOrder.BIG_ENDIAN).getInt();
  }
  
  public static int getInt(byte[] paramArrayOfByte, int paramInt)
  {
    return ByteBuffer.wrap(fillBytes(paramArrayOfByte, 4), paramInt, 4).order(ByteOrder.BIG_ENDIAN).getInt();
  }
  ...
  {
    return ByteBuffer.wrap(fillBytes(paramArrayOfByte, 8)).order(ByteOrder.BIG_ENDIAN).getLong();
  }
  
  public static long getLong(byte[] paramArrayOfByte, int paramInt)
  {
    return ByteBuffer.wrap(fillBytes(paramArrayOfByte, 8), paramInt, 8).order(ByteOrder.BIG_ENDIAN).getLong();
  }
  
  public static short getShort(byte[] paramArrayOfByte)
  {
    return ByteBuffer.wrap(fillBytes(paramArrayOfByte, 2)).order(ByteOrder.BIG_ENDIAN).getShort();
  }
  
  public static short getShort(byte[] paramArrayOfByte, int paramInt)
  {
    return ByteBuffer.wrap(fillBytes(paramArrayOfByte, 2), paramInt, 2).order(ByteOrder.BIG_ENDIAN).getShort();
  }
  ...
  public static long getUInt(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    return ByteBuffer.wrap(fillBytes(arrayOfByte, 8), 0, 8).order(ByteOrder.BIG_ENDIAN).getLong();
  }
  ...
  public static int getUShort(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    return ByteBuffer.wrap(fillBytes(arrayOfByte, 4), 0, 4).order(ByteOrder.BIG_ENDIAN).getInt();
  }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x87b1d00c-dex2jar.jar!\dji\midware\media\mp4\MP4BytesUtil.class
