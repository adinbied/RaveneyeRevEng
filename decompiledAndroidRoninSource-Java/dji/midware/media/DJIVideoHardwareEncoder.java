...
public class DJIVideoHardwareEncoder
{
  ...
  {
    start(paramInt1, paramInt2, this.originKeyframeRate);
  }
  
  /* Error */
  public void start(int arg1, int arg2, int arg3)
  {
    // Byte code:
    //   0: return
    //   1: astore 4
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x87b1d00c-dex2jar.jar!\dji\midware\media\DJIVideoHardwareEncoder.class
