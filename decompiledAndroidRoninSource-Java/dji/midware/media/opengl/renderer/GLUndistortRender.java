  ...
  extends GLRenderBase
{
  ...
  public GLUndistortRender(boolean paramBoolean, float paramFloat)
  {
    ...
    int i = 0;
    paramFloat = -f;
    this.mTriangleVerticesData = new float[] { -1.0F, paramFloat, 0.0F, 0.0F, 0.0F, 0.0F, paramFloat, 0.0F, 1.0F, 0.0F, -1.0F, f, 0.0F, 0.0F, 1.0F, 0.0F, f, 0.0F, 1.0F, 1.0F, 0.0F, paramFloat, 0.0F, 0.0F, 0.0F, 1.0F, paramFloat, 0.0F, 1.0F, 0.0F, 0.0F, f, 0.0F, 0.0F, 1.0F, 1.0F, f, 0.0F, 1.0F, 1.0F };
    while (i < 4)
    {
      float[] arrayOfFloat = this.mTriangleVerticesData;
      int j = i * 10;
      int k = j + 3;
      arrayOfFloat[k] += 0.25F;
      arrayOfFloat = this.mTriangleVerticesData;
      j += 8;
      arrayOfFloat[j] -= 0.25F;
      i += 1;
    }
  }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x87b1d00c-dex2jar.jar!\dji\midware\media\opengl\renderer\GLUndistortRender.class
