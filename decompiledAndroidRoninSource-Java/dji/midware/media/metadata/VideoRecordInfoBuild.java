...
public class VideoRecordInfoBuild
{
  ...
  public VideoRecordInfoBuild(Date paramDate, int paramInt1, int paramInt2, String paramString1, String paramString2)
  {
    VideoRecordInfo localVideoRecordInfo = new VideoRecordInfo();
    this.flightInfo = localVideoRecordInfo;
    localVideoRecordInfo.setCaptureDate(paramDate);
    ...
    this.flightInfo.setLocalFileName(paramString1);
    ...
    DataCameraGetVideoParams.getInstance().start(new DJIDataCallBack()
    {
      ...
      {
        VideoRecordInfoBuild.this.onEvent3BackgroundThread((DataCameraGetVideoParams)paramAnonymousObject);
      }
    });
    DJIEventBusUtil.register(this);
    MediaLogger.i("VideoRecordInfoBuild", "initilized");
  }
  ...
  {
    this.flightInfo.setEndTimeMsec(paramInt);
  }
  
  public void setFilePath(String paramString)
  {
    this.flightInfo.sourceFilePath = paramString;
  }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x87b1d00c-dex2jar.jar!\dji\midware\media\metadata\VideoRecordInfoBuild.class
