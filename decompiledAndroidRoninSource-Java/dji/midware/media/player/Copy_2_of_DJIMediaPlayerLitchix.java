...
class Copy_2_of_DJIMediaPlayerLitchix
  extends DJIMediaPlayer
{
  ...
  public Copy_2_of_DJIMediaPlayerLitchix()
  {
    super(new int[0]);
  ...
  /* Error */
  private void parseData(byte[] arg1, int arg2)
  {
    // Byte code:
    //   0: return
    //   1: astore_1
  ...
  {
    DJIStreamLoader localDJIStreamLoader = this.streamLoader;
    if (localDJIStreamLoader != null) {
      localDJIStreamLoader.abort();
    }
  }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x87b1d00c-dex2jar.jar!\dji\midware\media\player\Copy_2_of_DJIMediaPlayerLitchix.class
