  ...
  implements AudioManager.OnAudioFocusChangeListener
{
  ...
  public DJIAudioDecoder(PacketFormat paramPacketFormat)
  {
    this.packetFormat = paramPacketFormat;
  }
  
  public DJIAudioDecoder(PacketFormat paramPacketFormat, Context paramContext)
  {
    this.packetFormat = paramPacketFormat;
  ...
  public static enum PacketFormat
  {
    static
    {
      PacketFormat localPacketFormat = new PacketFormat("RAW", 1);
      RAW = localPacketFormat;
      $VALUES = new PacketFormat[] { ADTS, localPacketFormat };
    }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x87b1d00c-dex2jar.jar!\dji\midware\media\DJIAudioDecoder.class
