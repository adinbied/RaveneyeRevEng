...
public class FinalDb
{
  ...
  {
    this.db = generateDb(paramDaoConfig);
  ...
  /* Error */
  public void exeSql(String arg1)
  {
    // Byte code:
    //   0: return
    //   1: astore_1
    ...
    extends SQLiteOpenHelper
  {
    ...
    public SqliteDbHelper(Context paramContext, String paramString, int paramInt, FinalDb.DbUpdateListener paramDbUpdateListener)
    {
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x87b1d00c-dex2jar.jar!\dji\thirdparty\afinal\FinalDb.class
