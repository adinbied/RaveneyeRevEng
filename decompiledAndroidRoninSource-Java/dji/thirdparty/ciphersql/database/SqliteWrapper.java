...
public final class SqliteWrapper
{
  ...
  public static dji.thirdparty.ciphersql.Cursor query(Context paramContext, ContentResolver paramContentResolver, Uri paramUri, String[] paramArrayOfString1, String paramString1, String[] paramArrayOfString2, String paramString2)
  {
    try
    {
      paramContentResolver = (dji.thirdparty.ciphersql.Cursor)paramContentResolver.query(paramUri, paramArrayOfString1, paramString1, paramArrayOfString2, paramString2);
      return paramContentResolver;
    }
    catch (SQLiteException paramContentResolver)
    {
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x87b1d00c-dex2jar.jar!\dji\thirdparty\ciphersql\database\SqliteWrapper.class
