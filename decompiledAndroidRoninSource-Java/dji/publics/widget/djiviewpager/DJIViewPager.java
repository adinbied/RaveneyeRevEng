  ...
  extends ViewPager
{
  ...
  public DJIViewPager(Context paramContext)
  {
    this(paramContext, null);
  }
  
  public DJIViewPager(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    i = 1.$SwitchMap$dji$publics$widget$djiviewpager$DJIViewPager$TransitionEffect[this.mEffect.ordinal()];
    if ((i == 1) || (i == 2)) {
      setFadeEnabled(true);
    }
...
/* Location:              C:\Users\adinb\Downloads\dex2jar-2.0\dex2jar-2.0\0x87b1d00c-dex2jar.jar!\dji\publics\widget\djiviewpager\DJIViewPager.class
